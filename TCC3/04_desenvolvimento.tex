...
- image: Imagem de input decodificada
...
As falhas fixas (input, output e filtro) são injetadas durante 3 iterações da convolução, na linha 30 e na linha 60 e 90 da imagem, que correspondem à aproximadamente um terço do processo.

As falhas aleatórias são injetadas nos mesmos pontos da convolução, mas afetam um pedaço arbitrário de pilha
