...
Primeiramente são sorteados 4 falhas fixas dos símbolos, 2 globais e 2 locais da lista acima. Também é sorteado 2 deslocamentos para as corrupções na pilha. É feito o flash do programa de teste na placa e inicia-se uma sessão de debugging no ST-Link. 

% TODO: Imagem no VScode

O programa sempre será pausado logo após o setup inicial das arenas, o teste será re-executado para cada uma das 
