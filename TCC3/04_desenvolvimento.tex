...
% TODO: Referenciar o quadro de RawTask
% TODO: Referenciar o quadro de BasicTask
% TODO: Referenciar o quadro de exemplo de basictask
...
A classe genérica \texttt{BasicTask} incrementa a classe \texttt{RawTask} com conveniência adicional do uso de funções anônimas com grupos de captura e garantia de tipagem de seu retorno.
...
Apesar da implementação mais complexa que necessita lidar com restrições de tipos em funções anônimas, construção in-place e uso adequado do alinhamento de estruturas para o layout dos grupos de captura, o uso desta classe é relativamente ergonômico sendo similar a classe \texttt{std::thread} da biblioteca padrão introduzida no C++11.

\begin{quadro}[H]
    \centering
    \caption{Utilizando uma Basic Task para calcular uma soma}
...
\begin{quadro}[H]
    \centering
    \caption{Declaração da estrutura \texttt{DeadlinewWatcher}}
