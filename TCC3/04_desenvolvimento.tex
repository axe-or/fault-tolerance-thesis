...
Apesar da implementação mais complexa que necessita lidar com restrições de tipos em funções anônimas, construção in-place e uso adequado do alinhamento de estruturas para o layout dos grupos de captura, o uso desta classe é relativamente ergonômico sendo similar a classe \texttt{std::thread} da biblioteca padrão introduzida no C++11. Um exemplo é demonstrado no Quadro \autoref{cod:basicTaskExample}.
...
\subsection{Deadlines & Heartbeat}
