...
Para melhorar a propriedade de dependabilidade do sistema, foram exploradas técnicas de execução e de checagem de integridade, em cenários de falhas transientes.
...
Para elaboração de trabalhos futuros, é importante analisar o impacto da presença de múltiplos núcleos em um sistema com multi processamento simétrico, assim como expandir a análise para incluir análise
