...
\section{Mecanismos de Tolerância}

Esta seção aborda de uma forma mais direta como a detecção afeta de erros ocorrem em detalhes. Primeiramente, sem utilizar Reexecução ou TMR, é possível observar o comportamento do CRC nas linhas. Após a iteração da imagem, cada linha possui um CRC32 associado, 
