...
Para observar o resultado, basta definir a macro \texttt{DUMP_BITMAP} e redirecionar a saída do microCOM para um arquivo PGM. Em um sistema POSIX seria algo como \texttt{microcom -f -p /dev/ttyACM0 > out.pgm}

Refazendo o processo acima com a saída redirecionada é possível observar o output da imagem com o filtro Sobel aplicado como desmonstrado nas figuras ?? e ??.

\textbf{[FOTO DO GATO NORMAL E GATO SOBEL]}
