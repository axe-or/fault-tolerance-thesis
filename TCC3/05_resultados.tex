...
\section{Consenso (TMR) em Detalhes}
...
Foram selecionadas execuções que resultam em um output que possa ser visualizado para demonstrar o efeito dos upsetsno consigo

\textbf{[TROCAR FOTO DA LENA PELO GATO]}
