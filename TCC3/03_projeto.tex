...
\subsubsection{Sinal Heartbeat / Deadline}
...
A segunda rodada consiste em escolher um deslocamento aleatório da base do stack de uma tarefa em execução e causar um upset em 16 bytes subsequentes. O objetivo deste teste é avaliar como as tarefas irão se comportar na presença de uma falha que diretamente corrompe seu estado interno.
