...
\input{_info.tex} \clearpage

\input{0_pre_textual.tex} \clearpage

\textual % Indica inicio dos elementos textuais
\pagestyle{simple} % remove o cabecalho

\input{1_introducao.tex} \clearpage
\input{2_fundamentacao.tex} \clearpage
\input{3_projeto.tex} \clearpage
\input{4_consideracoes} \clearpage
% TCC 3
