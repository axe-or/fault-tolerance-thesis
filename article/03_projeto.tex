...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=1.0\textwidth]{assets/visao_geral.png}}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.80\textwidth]{assets/stm32_blackpill.png}}
    \captionsetup{justification=raggedright}
...
\begin{figure}[H]
    ...
    \captionsetup{justification=centering}
    \caption{ST-LINK/V2}
	\fbox{\includegraphics[width=0.40\textwidth]{assets/st_link.png}}
    \captionsetup{justification=raggedright}
...
\begin{figure}[H]
    ...
    \captionsetup{justification=centering}
    \caption{STMCubeIDE}
	\fbox{\includegraphics[width=0.65\textwidth]{assets/stmcube_ide.png}}
    \captionsetup{justification=raggedright}
...
\begin{figure}[H]
   ...
   \fbox{\includegraphics[width=0.85\textwidth]{assets/injecao_hardware.png}}
   \captionsetup{justification=raggedright}
  \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.50\textwidth]{assets/payload_layout.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.90\textwidth]{assets/task_bdd.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
    \label{fig:bddTarefa}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.950\textwidth]{assets/tmr_bdd.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
    \label{fig:bddTMR}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.925\textwidth]{assets/state_reexec.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.95\textwidth]{assets/heartbeat_signal.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=0.90\textwidth]{assets/programa_teste.png}}
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
