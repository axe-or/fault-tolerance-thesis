...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{assets/inj_start_debugger.png} \\
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{assets/inj_connect_com.png} \\
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.98\textwidth]{assets/inj_cond_breakpoint.png} \\
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.85\textwidth]{assets/inj_cause_upset.png} \\
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.65\textwidth]{assets/inj_resultado_virtualcom.png} \\
    \captionsetup{justification=raggedright}
    \caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.95\textwidth]{assets/cat_regular_to_sobel.png} \\
	\captionsetup{justification=raggedright}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.0\textwidth]{assets/crc_demo_1.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:crcDemo1}
\end{figure}
\begin{figure}[H]
	...
	\includegraphics[width=1.0\textwidth]{assets/crc_demo_2.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:crcDemo2}
\end{figure}
\begin{figure}[H]
	...
	\includegraphics[width=1.0\textwidth]{assets/crc_demo_3.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:crcDemo3}
\end{figure}
\begin{figure}[H]
	...
	\includegraphics[width=0.95\textwidth]{assets/crc_demo_4.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:crcDemo4}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.95\textwidth]{assets/tmr_demo_1.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:tmrDemo1}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.95\textwidth]{assets/tmr_demo_2.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:tmrDemo2}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.95\textwidth]{assets/tmr_demo_3.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
	\label{fig:tmrDemo3}
\end{figure}
...
\section{Impacto de falhas no Output}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.3\textwidth]{assets/cat_sobel_kernel_upset.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.3\textwidth]{assets/cat_sobel_subtle_upset.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.3\textwidth]{assets/cat_sobel_interrupted.png} \\
	\captionsetup{justification=raggedright}
	\caption*{Fonte: Elaborada pelo autor}
...
No \autoref{tab:verif} são verificados os requisitos funcionais estabelecidos na análise de requisitos da \autoref{sec:req}. A validação de cada requisito foi realizada através de métodos específicos: \textbf{RF01} através da execução dos experimentos, \textbf{RF02} pela interface de configuração desenvolvida, \textbf{RF03} pelos testes sem injeção de falhas, \textbf{RF04} pela comparação de dependabilidade entre técnicas, e \textbf{RF05} pela implementação do sistema de monitoramento. Todos os requisitos funcionais foram satisfatoriamente atendidos.
